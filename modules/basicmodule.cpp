...
//    m_expressionBar->initTheme(DThemeManager::instance()->theme());
//    connect(DThemeManager::instance(), &DGuiApplicationHelper::themeTypeChanged,
//            m_expressionBar, &ExpressionBar::initTheme);

//    QPalette pal = this->palette();
//    pal.setColor(QPalette::Light, QColor(248, 248, 248));
//    this->setPalette(pal);

//    connect(DThemeManager::instance(), &DGuiApplicationHelper::paletteTypeChanged, this,
...
void BasicModule::initTheme()
{
    ...
    m_expressionBar->initTheme(theme);
    /*switch (type) {
    case 0: case 1:
        m_expBarColor = "#F8F8F8";
        m_expBarSepColor = "#F8F8F8";
